                    ...
                    >
                      ...
                      <div className="p-2 sm:p-3 w-full text-center">
                        ...
                        <span className="text-xs opacity-70 mt-1 flex items-center justify-center text-center">
                          {yearData.accessible ? (
                            <><Eye className="h-2 w-2 sm:h-3 sm:w-3 mr-1 flex-shrink-0" /><span className="hidden sm:inline text-cyan-400">View Yearbook</span><span className="sm:hidden text-cyan-400">View</span></>
                          ) : yearData.canPurchase ? (
