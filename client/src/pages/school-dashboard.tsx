              ...
              <CardContent>
                ...
                <div className="mb-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <SelectTrigger className="bg-white/10 backdrop-blur-lg border border-white/20 text-white" data-testid="select-graduation-year-filter">
                ...
                {(() => {
                  ...
                  const filteredAlumni = alumniBadges.filter((badge) => {
                    ...
                    // Graduation year filter
                    const matchesGradYear = alumniGraduationYearFilter === 'all' || 
