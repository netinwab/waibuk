          ...
          <div className="flex justify-center items-center min-h-[60vh] sm:min-h-[70vh] relative">
            ...
            >
              ...
              >
                {/* Left Page */}
                {contentPages[currentPage] && (
                  <div className="bg-white shadow-lg border border-gray-300 relative flex-1"
          ...
          <div className="flex justify-center items-center min-h-[60vh] sm:min-h-[70vh] relative">
            ...
            >
              ...
              >
                {/* Left Page */}
                {contentPages[currentPage] && (
                  <div className="bg-white border-r border-gray-300 relative flex-1"
                ...
                {/* Right Page */}
                {contentPages[currentPage + 1] && (
                  <div className="bg-white border-l border-gray-300 relative flex-1"
                       style={{ aspectRatio: '4/3' }}>
                    <div className="h-full relative">
                      <img
                        src={getSecureImageUrl(contentPages[currentPage + 1].imageUrl)}
