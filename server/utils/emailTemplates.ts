      ...
      ">
        ...
        ">
          ...
          <p style="
            ...
            text-align: center;
          ">
            © ${new Date().getFullYear()} Waibuk. Where School Memories Live Forever.
          </p>
        </div>
      </div>
    </body>
...
export function createPasswordResetEmail(resetLink: string): string {
  return createEmailTemplate({
    title: 'Reset Your Waibuk Password',
    ...
    body: `
      <p style="color: white; font-size: 16px; line-height: 1.6; margin: 0 0 16px 0;">
        We received a request to reset your password for your Waibuk account.
      </p>
  ...
  return createEmailTemplate({
    ...
    body: `
      ...
      <p style="color: white; font-size: 16px; line-height: 1.6; margin: 0 0 16px 0; text-align: center;">
        <strong>Your Waibuk password was successfully changed.</strong>
      </p>
...
export function createSchoolVerificationEmail(verificationLink: string, schoolName: string): string {
  return createEmailTemplate({
    ...
    body: `
      <p style="color: white; font-size: 16px; line-height: 1.6; margin: 0 0 16px 0;">
        Thank you for registering <strong>${schoolName}</strong> with Waibuk!
      </p>
      <p style="color: #cbd5e1; font-size: 15px; line-height: 1.6; margin: 0 0 16px 0;">
...
export function createSchoolApprovalEmail(
  ...
  return createEmailTemplate({
    ...
    preheader: 'Your school has been approved on Waibuk',
    greeting: 'Congratulations!',
    body: `
      <p style="color: white; font-size: 16px; line-height: 1.6; margin: 0 0 16px 0;">
        <strong>${schoolName}</strong> has been approved and is now active on Waibuk!
      </p>
      <div style="
        background: rgba(59, 130, 246, 0.1);
...
export function createSchoolRejectionEmail(
  ...
  return createEmailTemplate({
    ...
    body: `
      <p style="color: white; font-size: 16px; line-height: 1.6; margin: 0 0 16px 0;">
        Thank you for your interest in registering <strong>${schoolName}</strong> with Waibuk.
      </p>
      <div style="
...
export function createTestEmail(): string {
  return createEmailTemplate({
    title: 'Waibuk Email System Test',
    preheader: 'Testing email delivery',
    greeting: 'Email Test Successful!',
    body: `
      <p style="color: white; font-size: 16px; line-height: 1.6; margin: 0 0 16px 0;">
        This is a test email from Waibuk's automated email system.
      </p>
      <div style="
